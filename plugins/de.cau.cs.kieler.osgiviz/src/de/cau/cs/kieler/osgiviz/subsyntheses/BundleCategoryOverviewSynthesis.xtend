    ...
    override transform(BundleCategoryOverviewContext bundleCategoryOverviewContext) {
        return #[
            createNode => [
                ...
                val isFocus = bundleCategoryOverviewContext.rootVisualization.focus === bundleCategoryOverviewContext
                addOverviewRendering("Bundle Categories", bundleCategoryOverviewContext.overviewText, false, isFocus, usedContext)
