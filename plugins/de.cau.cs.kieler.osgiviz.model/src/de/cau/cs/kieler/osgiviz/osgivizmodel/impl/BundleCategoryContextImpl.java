...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bundle Category Context</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class BundleCategoryContextImpl extends MinimalEObjectImpl.Container implements BundleCategoryContext {
	/**
	 ...
	 * @generated
	 */
	protected BundleCategoryContextImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OsgivizmodelPackage.Literals.BUNDLE_CATEGORY_CONTEXT;
	}
	...
	public BundleCategory getModelElement() {
		if (modelElement != null && ((EObject)modelElement).eIsProxy()) {
			...
			modelElement = (BundleCategory)eResolveProxy(oldModelElement);
			if (modelElement != oldModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__MODEL_ELEMENT, oldModelElement, modelElement));
			}
		}
		return modelElement;
	}
	 ...
	 * @generated
	 */
	public BundleCategory basicGetModelElement() {
		return modelElement;
	}
	...
	public void setModelElement(BundleCategory newModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__MODEL_ELEMENT, oldModelElement, modelElement));
	}
	...
	public NotificationChain basicSetParent(IVisualizationContext<?> newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(IVisualizationContext<?> newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__PARENT, newParent, newParent));
	}
	...
	public BundleOverviewContext getBundleOverviewContext() {
		if (bundleOverviewContext != null && bundleOverviewContext.eIsProxy()) {
			...
			if (bundleOverviewContext != oldBundleOverviewContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__BUNDLE_OVERVIEW_CONTEXT, oldBundleOverviewContext, bundleOverviewContext));
			}
		}
	...
	public void setBundleOverviewContext(BundleOverviewContext newBundleOverviewContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__BUNDLE_OVERVIEW_CONTEXT, oldBundleOverviewContext, bundleOverviewContext));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__CHILD_CONTEXTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__MODEL_ELEMENT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__CHILD_CONTEXTS:
				...
				return;
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__MODEL_ELEMENT:
				setModelElement((BundleCategory)newValue);
				return;
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__PARENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__CHILD_CONTEXTS:
				...
				return;
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__MODEL_ELEMENT:
				setModelElement((BundleCategory)null);
				return;
			case OsgivizmodelPackage.BUNDLE_CATEGORY_CONTEXT__PARENT:
